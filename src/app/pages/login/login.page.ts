...
@Component({
  ...
  changeDetection: ChangeDetectionStrategy.Default //changing to default as the otp component for reset password need to show continous time for otp expiry
})
